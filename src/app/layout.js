...
export default function RootLayout({ children }) {
    ...
    const data = [
        ...
        {
            title: "Chat System view",
            desc: 'A basic chat system UI design with no backend attached to it at the moment',
            dest_link: '/ChatView',
            author_link: 'https://github.com/heebu',
            author_name: 'Idris Adedeji',
            author_image: 'https://avatar.iran.liara.run/public/56',
            image: 'https://d2mkz4zdclmlek.cloudfront.net/blog/wp-content/uploads/2021/03/rocketchat.png',
                    ...
                    <header className="sm:px-10 md:px-10 lg:px-20 px-0 bg-navlinkhover">
                        ...
                        <div className="">
                            <div className="lg:pt-10 md:pt-10 sm:pt-10">
                                <div
                                    className="w-50 sm:w-100 flex justify-between items-center bg-white p-3 lg:rounded-t-2xl md:rounded-t-2xl sm:rounded-t-2xl rounded-t-0 border border-b">
                                    <div className="flex items-center justify-center">
                                        <Image src={logo} width={50} height={50} className="mr-3" alt="logo" priority />
                                        <h1 className=" m-0"><span className="font-bold text-2xl">React Frontend</span>
                                            <br /><span className="text-xs">Practice and Exercises</span></h1>
                                    </div>
                                    <div className="flex">
                                        <div className="flex">
                                            <a target="_blank" href="https://github.com/jolawale28"
                                                className="mr-3 hover:scale-105 rounded-md" title="Joseph Olawale B.">
                                                <img src="https://avatar.iran.liara.run/public/20"
                                                    style={{ width: '30px', height: '30px' }} alt="profileJ" />
                                            </a>
                                            <a target="_blank" href="https://github.com/heebu"
                                                className="mr-3 hover:scale-105 rounded-md" title="Idris Adedeji">
                                                <img src="https://avatar.iran.liara.run/public/56"
                                                    style={{ width: '30px', height: '30px' }} alt="profileH" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
